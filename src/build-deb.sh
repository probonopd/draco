...
Priority: optional
Architecture: ${ARCH}
Depends: bash (>=4.0), libxcb-ewmh2, libxcb-composite0, libxcb-damage0, qterminal, pnmixer, openbox, hicolor-icon-theme, xscreensaver, xdg-utils, openbox, udisks2, upower
